...
HD_PWD='D:/computer_composition/MIPS54/cpu_54/cpu_54.runs/imen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source imen.tcl
