...
HD_PWD='D:/computer_composition/MIPS54/cpu_54/cpu_54.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sccomp_dataflow.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sccomp_dataflow.tcl -notrace
